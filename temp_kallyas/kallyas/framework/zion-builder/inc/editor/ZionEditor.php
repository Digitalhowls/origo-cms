...
class ZionEditor {
	...
	public function __construct() {
		...
		if ( ZNB()->utility->isRequest( 'ajax' ) ) {
			...
			// Load zip exporters
			require __DIR__ . '/ZionPageBuilderExportHelper.php';
			require __DIR__ . '/class-page-builder-ajax.php';
		}
	}
	...
	public function beforeElement( $element ) {
		...
		} elseif ( ! empty( $element->data['options']['column_offset'] ) ) {
	...
	public function loadScripts() {
		...
		wp_enqueue_style( 'zion-editor-style', ZNB()->plugin_url . '/dist/znpb_editor.css', [], ZNB()->version );
		...
		wp_enqueue_script(
			'zion-editor-script',
			ZNB()->plugin_url . '/dist/znpb_editor.js',
