...
class ZnHgTFw_Theme_Installer {
	...
	/**
	 * Holds a reference to DB updates ( updates that needs more processing power )
	 * @var array
	 */
	private $_db_updates = array();

	/**
	 * Holds a reference to normal updates ( updates that can run on a single page reload )
	 * @var array
	 */
