      ...
      <div className="border-t pt-4 space-y-4">
          ...
          <div key={item.id} className="border rounded-md p-3 space-y-3 bg-background">
            ...
            <div className="grid gap-2">
              ...
              <textarea
                ...
                placeholder="Contenido del elemento. Puede utilizar HTML."
              />
            </div>
            ...
            <div className="flex items-center space-x-2">
              ...
              />
              <label className="text-sm" htmlFor={`item-open-${item.id}`}>
                Abierto por defecto
              </label>
            </div>
          </div>
        ...
        {items.length === 0 && (
          <div className="text-center py-4 border border-dashed rounded-md">
            <p className="text-gray-500">No hay elementos en el acordeón</p>
            <Button 
              variant="outline" 
              size="sm" 
              onClick={handleAddItem}
