      ...
      >
        ...
        <div className="py-10">
          <div className={`flex ${flexDirectionClass} gap-8 max-w-6xl mx-auto`}>
            <AnimateCss 
              animationName={isHovered ? (isMediaLeft || isMediaTop ? "fadeInLeft" : "fadeInRight") : ""}
              duration="0.6s"
            >
            ...
            <AnimateCss 
              animationName={isHovered ? (isMediaRight || isMediaBottom ? "fadeInLeft" : "fadeInRight") : ""}
              duration="0.6s"
            >
              <div className={`${contentWidthClass} ${contentOrderClass} ${isMediaBottom ? 'order-1' : isMediaTop ? 'order-2' : ''}`}>
                <AnimateCss animationName={isHovered ? "fadeInDown" : ""} duration="0.5s">
                  <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-4">{title}</h2>
                </AnimateCss>
                
                <AnimateCss animationName={isHovered ? "fadeIn" : ""} duration="0.7s" delay="0.1s">
                ...
                <AnimateCss animationName={isHovered ? "fadeInUp" : ""} duration="0.5s" delay="0.2s">
                  <a 
                    href={ctaUrl} 
                  ...
                  >
                    ...
                    <svg 
                      ...
                      className={`h-5 w-5 ml-1 ${isHovered ? 'animate-bounce-x' : ''}`}
                      viewBox="0 0 20 20" 
                      fill="currentColor"
                    >
                      <path 
